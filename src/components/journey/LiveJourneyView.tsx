...
import { ArrowLeft, Navigation, Pause, Play, Plus, CheckCircle2, AlertTriangle, X, Camera, Video, FileText, MapPin, DollarSign, Bus } from 'lucide-react';
    ...
    <div className="space-y-4 py-3 max-w-xl mx-auto">
      ...
      <div className="flex items-center justify-between px-1">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-mono font-bold text-emerald-400">LIVE NAVIGATION</span>
        </div>
      </div>
      ...
      <div className="glass-panel p-2 rounded-3xl border border-sky-500/30">
        <MapView route={route} heightClass="h-[220px] sm:h-[280px]" />
      </div>

      {/* 3. Current Step Card (Mobile Focus) */}
      {!showArrivalSurvey ? (
        <div className="glass-panel p-5 rounded-3xl border border-sky-500/40 bg-slate-950/95 space-y-4 shadow-2xl">
          ...
          {/* Large Current Step Instruction */}
          ...
          {!surveyCompleted ? (
            <>
              ...
              <p className="text-xs text-slate-300">
                Your quick answer helps future student commuters and travellers.
              </p>
        ...
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-end sm:items-center justify-center p-4">
          <div className="glass-panel p-5 rounded-3xl w-full max-w-sm border border-sky-500/40 bg-slate-950 space-y-4 shadow-2xl">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              ...
              <button
                onClick={() => handleTriggerAction('Change Mode')}
                className="p-3 rounded-2xl bg-slate-900 border border-slate-800 hover:border-sky-500 text-left font-bold text-slate-200 flex items-center gap-2"
              >
              ...
              <button
                onClick={() => handleTriggerAction('Update Fare')}
                className="p-3 rounded-2xl bg-slate-900 border border-slate-800 hover:border-sky-500 text-left font-bold text-slate-200 flex items-center gap-2"
              >
